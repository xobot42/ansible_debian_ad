...
def smart_parser(smart_out, disk, hostname):
	smart_attr = {'Model Family': 'model', 'Device Model': 'product', 'User Capacity': 'capacity', 'Product': 'product',
				  'Transport protocol': 'model', 'Rotation Rate': 'rotation_rate', '0x05': 'reallocated_sectors', '0x09': 'power_on_hours',
				  '0xc2': 'temperature',
				  '0xc5': 'current_pending_sectors', '0xc6': 'uncorrectable_sectors', '0xc7': 'crc_error',
				  '0xbe': 'airflow_temperature', '0xab': 'program_fail_count_chip', 'oxac': 'erase_fail_count',
	...
	for line in smart_out:
		...
		if param in smart_attr:
			if zabbix_key == 'info':
				...
				data = (re.sub(r'\xa0', ' ', data)).encode('utf8')
