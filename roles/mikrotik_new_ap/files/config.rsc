...
# software id = AE97-2I2K
#
# model = RouterBOARD wAP G-5HacT2HnD
# serial number = 7DF108AE208B
/interface wireless
# managed by CAPsMAN
...
/ip address
add address=192.168.6.7/16 interface=ether1 network=192.168.0.0
...
/snmp
set contact=Saber3D enabled=yes location=openspace trap-version=2
/system clock
set time-zone-name=Europe/Moscow
/system identity
set name=wi-fi_openspace_stoyka
/system ntp client
